-- 쇼핑몰_팀
/*DROP SCHEMA IF EXISTS proj21_admin;*/

-- 쇼핑몰_팀
/*CREATE SCHEMA proj21_admin;*/


-- 회원
CREATE TABLE proj21_admin.MEMBER (
...
-- 회원
ALTER TABLE proj21_admin.MEMBER
...
-- 후기
CREATE TABLE proj21_admin.REVIEW (
...
-- 후기
ALTER TABLE proj21_admin.REVIEW
...
-- 후기덧글
CREATE TABLE proj21_admin.RE_REPLY (
...
-- 후기덧글
ALTER TABLE proj21_admin.RE_REPLY
...
-- 장바구니
CREATE TABLE proj21_admin.CART (
...
-- 제품
CREATE TABLE proj21_admin.PRODUCT (
...
-- 제품
ALTER TABLE proj21_admin.PRODUCT
...
-- 제품이미지
CREATE TABLE proj21_admin.PRO_IMG (
	pro_num           INT          NULL     COMMENT '제품번호', -- 제품번호
...
-- 제품이미지
ALTER TABLE proj21_admin.PRO_IMG
...
-- 주문
CREATE TABLE proj21_admin.ORDER (
...
-- 주문
ALTER TABLE proj21_admin.ORDER
...
-- 주소
CREATE TABLE proj21_admin.Address (
...
-- 주소
ALTER TABLE proj21_admin.Address
...
ALTER TABLE proj21_admin.REVIEW
	ADD CONSTRAINT FK_PRODUCT_TO_REVIEW -- 제품 -> 후기
		...
		REFERENCES proj21_admin.PRODUCT ( -- 제품
			pro_num -- 제품번호
		);
