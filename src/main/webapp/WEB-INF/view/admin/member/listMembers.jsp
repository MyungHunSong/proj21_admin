			...
			<div class="col-12">
				<div class="card">
					<div class="comment-widgets scrollable">
						...
						<h2>회원 목록</h2>
						<hr>
						<section> <!-- 어디 모델 -> 컨트롤러를 타고 왔나. --> <!-- Controller 경로 : proj21_shop.controller.admin.member/AdminMemberController -->
						<div id="listOrdersByStatus">
							<ul class="smallul">
								<li>회원&nbsp;<a
									href="${contextPath }/admin/member/listMembers">${totMembers }</a>
									건|
								</li>
								<li>남성회원&nbsp;<a
									href="${contextPath }/admin/member/listMembers">${allWomen }</a>건
									|
								</li>
								<li>여성회원&nbsp;<a
									href="${contextPath }/admin/member/listMembers">${allMen }</a>건
									|
								</li>
							</ul>
						</div>
						...
						<form action="${contextPath }/admin/membmer/listMembers"
							method="post" id="frm_search">
							<table>
								<tr>
									<td colspan="2">회원 검색&nbsp;&nbsp;</td>
									<td colspan="5" class="pleft">회원 이름 : <input type="text"
										name="memberName" placeholder="회원 이름을 입력하세요" id="memberName" />
									</td>
								</tr>
								<!-- Controller 경로 :  proj21_shop.controller.admin.member/AdminMemberController  -->
								<tr>
									<td colspan="2">회원성별 구분&nbsp;&nbsp;</td>
									<td colspan="5" class="pleft"><input type="radio" value=""
										name="memberGender" checked>전체 <input type="radio"
										value="1" name="memberGender">남성 <input type="radio"
										value="0" name="memberGender">여성</td>
								</tr>
								<tr>

									<td colspan="2">회원 분류&nbsp;&nbsp;</td>
									<td colspan="5" class="pleft"><select id="memberTotalBuy"
										name="memberTotalBuy">
									...
									</select> <select id="memberTotalOrder" name="memberTotalOrder">
						...
						<form>
							...
							<table
								style="border-color: #ddd #ddd #848484 #ddd; width: 100%; border: 1; text-align: center;">
									...
									<c:when test="${membersList !=null}">
										...
										<c:forEach var="member" items="${membersList }">
											<tr style="text-align: center;">
												<td><a
													href="${contextPath }/admin/member/viewMember?memberId=${member.memberId}"
													style="">${member.memberId }</a></td>
												<td><a
													href="${contextPath }/admin/member/viewMember?memberId=${member.memberId}">${member.memberName }</a></td>
